...
import iti.workshop.admin.databinding.AuthFragmentUsersListBinding
...
@AndroidEntryPoint
class AuthUsersListFragment : Fragment() {

    val viewModel: AuthViewModel by viewModels()
    lateinit var adapter: AuthEmployersAdapter
    lateinit var binding: AuthFragmentUsersListBinding
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.auth_fragment_users_list, container, false)
