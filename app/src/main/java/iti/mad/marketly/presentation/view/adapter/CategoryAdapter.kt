...
import iti.mad.marketly.presentation.view.DiffUtils.CategoryDiffUtils

class CategoryAdapter (var mClickListener: CategoryAdapter.ListItemClickListener) : ListAdapter<CustomCollection, CategoryAdapter.CategoryViewHolder>(
    CategoryDiffUtils()
) {
